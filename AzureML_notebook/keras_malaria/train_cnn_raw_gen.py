...
# load model
model = load_model(data_folder+'/model_raw_adam.h5')
# summarize model.
model.summary()
...
valtest_datagen = ImageDataGenerator(horizontal_flip=True, vertical_flip=True, rotation_range=90,
                                  width_shift_range=shift, height_shift_range=shift)
...
with open('./outputs/model/model_generator.json', 'w') as f:
    f.write(model_json)
# save model weights
model.save_weights('./outputs/model/model_generator.h5',overwrite=True)
print("model saved in ./outputs/model folder")

# save model and weights
model.save('./outputs/model/model_raw_gen.h5')
print("model saved in ./outputs/model folder")
